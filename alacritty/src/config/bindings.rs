...
pub enum Action {
    ...
    /// Close the current in-window tab.
    CloseTab,
...
fn common_keybindings() -> Vec<KeyBinding> {
    bindings!(
        ...
        "t",    ModifiersState::CONTROL | ModifiersState::SHIFT;                                         Action::CreateTab;
        ...
        "t",    ModifiersState::ALT     | ModifiersState::SHIFT;                                         Action::ToggleTabBar;
    )
}
